...
public class CompactCalendarView extends View {
    ...
    private final com.example.zubako.caliary.AnimationHandler animationHandler;
    ...
    public CompactCalendarView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        compactCalendarController = new com.example.zubako.caliary.CompactCalendarController(new Paint(), new OverScroller(getContext()),
                ...
                Color.argb(255, 100, 68, 65), new com.example.zubako.caliary.EventsContainer(Calendar.getInstance()),
                Locale.getDefault(), TimeZone.getDefault());
        gestureDetector = new GestureDetectorCompat(getContext(), gestureListener);
        animationHandler = new com.example.zubako.caliary.AnimationHandler(compactCalendarController, this);
    }
