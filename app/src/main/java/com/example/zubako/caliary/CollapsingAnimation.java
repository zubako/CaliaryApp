...
class CollapsingAnimation extends Animation {
    ...
    private final com.example.zubako.caliary.CompactCalendarView view;
    private int targetGrowRadius;
    private final boolean down;
    private com.example.zubako.caliary.CompactCalendarController compactCalendarController;

    public CollapsingAnimation(com.example.zubako.caliary.CompactCalendarView view, com.example.zubako.caliary.CompactCalendarController compactCalendarController, int targetHeight, int targetGrowRadius, boolean down) {
        this.view = view;
