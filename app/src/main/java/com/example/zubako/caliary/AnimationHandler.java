...
class AnimationHandler {
    ...
    private com.example.zubako.caliary.CompactCalendarController compactCalendarController;
    private com.example.zubako.caliary.CompactCalendarView compactCalendarView;
    private com.example.zubako.caliary.CompactCalendarView.CompactCalendarAnimationListener
            compactCalendarAnimationListener;

    AnimationHandler(com.example.zubako.caliary.CompactCalendarController
                             compactCalendarController, com.example.zubako.caliary.CompactCalendarView compactCalendarView) {
        this.compactCalendarController = compactCalendarController;
        this.compactCalendarView = compactCalendarView;
    }

    void setCompactCalendarAnimationListener
            (com.example.zubako.caliary.CompactCalendarView.CompactCalendarAnimationListener
                     compactCalendarAnimationListener){
        this.compactCalendarAnimationListener =
                compactCalendarAnimationListener;
    }
    ...
    void openCalendar() {
        ...
        heightAnim.setInterpolator(new
                AccelerateDecelerateInterpolator());
        compactCalendarController.setAnimationStatus
                (com.example.zubako.caliary.CompactCalendarController.EXPAND_COLLAPSE_CALENDAR);
    ...
    void closeCalendar() {
        ...
        compactCalendarController.setAnimationStatus
                (com.example.zubako.caliary.CompactCalendarController.EXPAND_COLLAPSE_CALENDAR);
        compactCalendarView.getLayoutParams().height =
                compactCalendarView.getHeight();
        compactCalendarView.requestLayout();
        compactCalendarView.startAnimation(heightAnim);
    }
    ...
    void openCalendarWithAnimation() {
        ...
        isAnimating = true;
        final Animator indicatorAnim = getIndicatorAnimator(1f,
                compactCalendarController.getDayIndicatorRadius());
        final Animation heightAnim = getExposeCollapsingAnimation
                (true);
        compactCalendarView.getLayoutParams().height = 0;
        compactCalendarView.requestLayout();
    ...
    void closeCalendarWithAnimation() {
        ...
        isAnimating = true;
        final Animator indicatorAnim = getIndicatorAnimator
                (compactCalendarController.getDayIndicatorRadius(), 1f);
        final Animation heightAnim = getExposeCollapsingAnimation
                (false);
        compactCalendarView.getLayoutParams().height =
                compactCalendarView.getHeight();
    ...
    private void setUpAnimationLisForExposeOpen(final Animator
                                                        indicatorAnim, Animation heightAnim) {
        heightAnim.setAnimationListener(new AnimationListener() {
            @Override
            public void onAnimationStart(Animation animation) {
                compactCalendarController.setAnimationStatus
                        (com.example.zubako.caliary.CompactCalendarController.EXPOSE_CALENDAR_ANIMATION);
            }
        ...
        indicatorAnim.addListener(new AnimatorListener() {
            ...
            public void onAnimationStart(Animator animation) {
                compactCalendarController.setAnimationStatus
                        (com.example.zubako.caliary.CompactCalendarController.ANIMATE_INDICATORS);
            }

            @Override
            public void onAnimationEnd(Animator animation) {
                compactCalendarController.setAnimationStatus
                        (com.example.zubako.caliary.CompactCalendarController.IDLE);
                onOpen();
                isAnimating = false;
            }
        });
    ...
    private void setUpAnimationLisForExposeClose(final Animator
                                                         indicatorAnim, Animation heightAnim) {
        heightAnim.setAnimationListener(new AnimationListener() {
            @Override
            public void onAnimationStart(Animation animation) {
    ...
    @NonNull
    private Animation getExposeCollapsingAnimation(final boolean
                                                           isCollapsing) {
    ...
    private Animation getCollapsingAnimation(boolean isCollapsing) {
        return new com.example.zubako.caliary.CollapsingAnimation(compactCalendarView,
                compactCalendarController, compactCalendarController.getTargetHeight(),
                getTargetGrowRadius(), isCollapsing);
    }
    ...
    private Animator getIndicatorAnimator(float from, float to) {
        ...
        animIndicator.addUpdateListener(new
                                                ValueAnimator.AnimatorUpdateListener() {
                                                    @Override
                                                    public void onAnimationUpdate(ValueAnimator animation) {
                                                        compactCalendarController.setGrowFactorIndicator
