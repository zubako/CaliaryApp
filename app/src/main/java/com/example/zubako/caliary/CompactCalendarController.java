...
import static com.example.zubako.caliary.CompactCalendarView.CompactCalendarViewListener;
import static com.example.zubako.caliary.CompactCalendarView.FILL_LARGE_INDICATOR;
import static com.example.zubako.caliary.CompactCalendarView.NO_FILL_LARGE_INDICATOR;
import static com.example.zubako.caliary.CompactCalendarView.SMALL_INDICATOR;
...
class CompactCalendarController {
    ...
    private com.example.zubako.caliary.EventsContainer eventsContainer;
    ...
    CompactCalendarController(Paint dayPaint, OverScroller scroller, Rect textSizeRect, AttributeSet attrs,
                              ...
                              int multiEventIndicatorColor, com.example.zubako.caliary.EventsContainer eventsContainer,
    ...
    void setLocale(TimeZone timeZone, Locale locale) {
        ...
        this.locale = locale;
        this.timeZone = timeZone;
        this.eventsContainer = new com.example.zubako.caliary.EventsContainer(Calendar.getInstance(this.timeZone, this.locale));
    ...
    void setUseWeekDayAbbreviation(boolean useThreeLetterAbbreviation) {
        ...
        this.dayColumnNames = com.example.zubako.caliary.WeekUtils.getWeekdayNames(locale, firstDayOfWeekToDraw, this.useThreeLetterAbbreviation);
    }
    ...
    void onMeasure(int width, int height, int paddingRight, int paddingLeft) {
        ...
        bigCircleIndicatorRadius = shouldDrawIndicatorsBelowSelectedDays && eventIndicatorStyle == com.example.zubako.caliary.CompactCalendarView.SMALL_INDICATOR ? bigCircleIndicatorRadius * 0.85f : bigCircleIndicatorRadius;
    }
